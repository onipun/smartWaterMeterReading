...
public class UploadImgController {
    ...
    public @ResponseBody String handleImageUpload(
		...
		try{
			FileOutputStream fos = new FileOutputStream("C:\\c.jpg"); //change the path where you want to save the image
			...
			return textDetection.imgProc(imagePath);	
            
		}
		catch(Exception e){
            System.out.println(e);
            return "check server (logcat), something wrong while parsing";
        }
